...
export const SCORING_TABLE: ScoreRow[] = [
  ...
  { fan: '1', name: 'Honour set', cantonese: 'faan pai 番牌', note: 'A pong/gong of any dragon, or of your own seat wind.' },
  ...
  { fan: '1', name: 'Robbing the gong', cantonese: 'cheung gong 抢降', note: 'Winning on the tile someone adds to their pong.' },
  { fan: '1', name: 'Win after gong', cantonese: '降上自摸', note: 'Winning on the replacement tile drawn after a gong.' },
  { fan: '1', name: 'Last tile win', cantonese: 'hoi dai lao yuet 海底捞月', note: 'Winning on the final tile of the wall.' },
  { fan: '1', name: 'Mixed terminals', cantonese: '花幺九', note: 'Only 1s, 9s and honour tiles.' },
  { fan: '2', name: 'Full flower set', cantonese: 'yut toi fa 一台花', note: 'All four flowers of one kind (1-2-3-4).' },
  { fan: '3', name: 'All triplets', cantonese: 'dou dou wu 对对糊', note: 'Every set is a pong/gong.' },
  ...
  { fan: '8', name: 'Gong on gong win', cantonese: '降上降自摸', note: 'Two gongs in a row, winning on the second replacement tile.' },
  { fan: '8', name: 'All eight flowers', cantonese: 'dai fa wu 大花糊', note: 'Collect all 8 flowers — instant win, even with an incomplete hand.' },
  { fan: '8', name: 'Concealed all triplets', cantonese: 'kan kan wu 坎坎糊', note: 'Fully concealed hand of triplets only.' },
